...
static char* lc_nonnull copyData(const void* lc_nonnull source, long size) {
...
LCMSColorProfile::LCMSColorProfile(const char* lc_nonnull data, long size):
_referenceCounter(1),
_data(data),
_size(size) {
    //
...
LCMSColorProfile* lc_nonnull LCMSColorProfile::create(const void* lc_nonnull data, long size) SWIFT_RETURNS_RETAINED {
    return new LCMSColorProfile(copyData(data, size), size);
}


LCMSColorProfile* lc_nonnull LCMSColorProfile::createRec709() SWIFT_RETURNS_RETAINED {
...
LCMSColorProfile* lc_nonnull LCMSColorProfile::createDCIP3() SWIFT_RETURNS_RETAINED {
...
LCMSColorProfile* lc_nonnull LCMSColorProfile::createDCIP3D65() SWIFT_RETURNS_RETAINED {
...
LCMSColorProfile* lc_nullable LCMSColorProfile::createLinear() SWIFT_RETURNS_RETAINED {
...
LCMSColorProfile* lc_nullable LCMSColorProfileRetain(LCMSColorProfile* lc_nullable value) SWIFT_RETURNS_UNRETAINED {
    if (value == nullptr) {
        return nullptr;
    }
...
void LCMSColorProfileRelease(LCMSColorProfile* lc_nullable value) {
    if (value == nullptr) {
        return;
    }
